  ...
  const renderVerificationStep = () => (
    <CardContent className="flex flex-col justify-center flex-grow text-center">
      ...
      <form onSubmit={handleVerificationSubmit} className="space-y-4">
        ...
        <div className="flex justify-center gap-3 mb-4 sm:gap-4">
        ...
        <Button
          type="submit"
          className="w-full text-white font-medium h-11 bg-gradient-to-r from-[#FFD700] to-[#780991] hover:from-yellow-600 hover:to-pink-600 rounded-[15px] transition-all duration-200 disabled:opacity-50"
