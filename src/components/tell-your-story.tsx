...
const TellYourStoryPopup: React.FC<TellYourStoryPopupProps> = ({ isOpen, onClose, activeSession = null, user }) => {
      ...
      <div className="relative p-5 max-w-[506px] mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <label
              htmlFor="photos"
              className="flex items-center justify-center w-full px-4 py-3 text-sm text-white transition border rounded-[12px] cursor-pointer  border-border "
            >
